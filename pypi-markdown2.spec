...
Source0  : https://files.pythonhosted.org/packages/eb/c3/d3ab39919b8f6341fdb388c4962c8a8b189d94b0b00954ff8189bd0adb50/markdown2-2.4.8.tar.gz
...
%prep
%setup -q -n markdown2-2.4.8
cd %{_builddir}/markdown2-2.4.8
pushd ..
cp -a markdown2-2.4.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676251291
