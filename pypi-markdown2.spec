...
Source0  : https://files.pythonhosted.org/packages/83/b7/24613765f558afde9f47b61fcd787a9856ac1515b53af38bd11bf2fb3c8c/markdown2-2.4.6.tar.gz
...
%prep
%setup -q -n markdown2-2.4.6
cd %{_builddir}/markdown2-2.4.6
pushd ..
cp -a markdown2-2.4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666279612
