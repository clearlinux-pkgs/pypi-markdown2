...
Source0  : https://files.pythonhosted.org/packages/a0/61/d3c0c21280ba1fc348822a4410847cf78f99bba8625755a5062a44d2e228/markdown2-2.5.2.tar.gz
...
%prep
%setup -q -n markdown2-2.5.2
cd %{_builddir}/markdown2-2.5.2
pushd ..
cp -a markdown2-2.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735097009
