...
Source0  : https://files.pythonhosted.org/packages/da/71/80c4ccbd8905ad6394291178182102c1a1496b785ea1b95b83e0ef2ffaa1/markdown2-2.4.5.tar.gz
...
%prep
%setup -q -n markdown2-2.4.5
cd %{_builddir}/markdown2-2.4.5
pushd ..
cp -a markdown2-2.4.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664206082
