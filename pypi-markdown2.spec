...
Source0  : https://files.pythonhosted.org/packages/44/52/d7dcc6284d59edb8301b8400435fbb4926a9b0f13a12b5cbaf3a4a54bb7b/markdown2-2.5.3.tar.gz
...
%prep
%setup -q -n markdown2-2.5.3
cd %{_builddir}/markdown2-2.5.3
pushd ..
cp -a markdown2-2.5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737997957
