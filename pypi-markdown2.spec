...
Source0  : https://files.pythonhosted.org/packages/2e/14/b5c2b291359560aa4e546c3ef2905c3b858491932bc8eef8c1b923afe9b8/markdown2-2.4.7.tar.gz
...
%prep
%setup -q -n markdown2-2.4.7
cd %{_builddir}/markdown2-2.4.7
pushd ..
cp -a markdown2-2.4.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674495152
