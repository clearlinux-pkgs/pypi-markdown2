...
Source0  : https://files.pythonhosted.org/packages/74/89/a6bb59171d0bd5a3b19deb834ec29378a7c8e05bcb0a4dd4e5cb418ea03b/markdown2-2.4.13.tar.gz
...
%prep
%setup -q -n markdown2-2.4.13
cd %{_builddir}/markdown2-2.4.13
pushd ..
cp -a markdown2-2.4.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708968435
